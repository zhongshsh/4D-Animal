...
COP3D_DATA_ROOT_PATH = "external_data/cop3d_data"


assert (
    EXTERNAL_DATA_PATH is not None
), "EXTERNAL_DATA_PATH missing in 'config/keys.py, please manually add it'"
assert (
    COP3D_DATA_ROOT_PATH is not None
), "COP3D_DATA_ROOT_PATH missing in 'config/keys.py', please manually add it"
...
class Keys:
    def __init__(self):
        ...
        self.source_part_masks = os.path.join(self.external_data_path, "part_masks")
        self.source_refined_masks = os.path.join(
            self.external_data_path, "refined_masks"
        )
        self.source_refined_keypoints = os.path.join(
            self.external_data_path, "sparse_keypoints"
        )
